...
export default function Secretariaulalista() {
  ...
  const validar = () =>{
    ...
    if (horarioDisponibilidad === '') {
        show_alert('Escribe el horario disponibilidad de la Aula', 'error');
    }
    if (notasAdicionales === '') {
					...
					<table className="table table-dark table-sm">
						...
						<tbody className="table-group-divider">
                          ...
                          <i className="fas fa-edit"></i>
									 ...
									 / &nbsp;
									<button onPress={() => handleDelete(aula.aulaId)} onClick={() => deleteAula(aula.docenteId, aula.nombres, aula.numeroTelefono, aula.cursosAsignados, aula.numeroIdentificacion, aula.apellidos)} className="btn btn-danger">
