...
export default function Secretariaacudientelista() {
  ...
  const enviarSolicitud = async (metodo, parametros) => {
    ...
    const deleteAcudiente = (acudienteId) => {
      ...
      MySwal.fire({
        title: '¿Está seguro que desea eliminar el acudiente?',
        ...
        if (result.isConfirmed) {
          try {
            ...
            document.getElementById("btnCerrar").click();
            getAcudiente();
            setcontadorAcudiente(contadorAcudiente - 1);
          }catch (error){
    ...
    return(
      ...
      <section className="full-box page-content">
        ...
        Total de acudiente registrados: {contadorAcudiente}
        </p>
			</div>
         ...
         >
          ...
          data-target="#ModalAcudiente" ><i className="fas fa-plus fa-fw"></i> Añadir Acudiente nuevo</a>
					...
					<li>
						<a className="active" href="/Secretariaacudientebuscar"><i className="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ACUDIENTES</a>
					</li>
					<li>
						<a style={{color: 'black'}} href="/Secretariabuscaracudiente"><i className="fas fa-search fa-fw"></i> &nbsp; BUSCAR ACUDIENTES</a>
					</li>
				</ul> 
			</div>
			<div className="container-fluid">
